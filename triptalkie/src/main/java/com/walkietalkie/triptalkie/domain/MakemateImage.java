...
public class MakemateImage {
	...
	public MakemateImage(Long idx, String uuid, String originalName, String savedName, String filePath, Long fileSize,
			Long makemateId, LocalDateTime createdAt, LocalDateTime updatedAt) {
		super();
		this.idx = idx;
		this.uuid = uuid;
	...
	public Long getMakemateId() {
		return makemateId;
	}

	public void setMakemateId(Long makemateId) {
		this.makemateId = makemateId;
	}
	...
	public String toString() {
		return "MakemateImage [idx=" + idx + ", uuid=" + uuid + ", originalName=" + originalName + ", savedName="
				+ savedName + ", filePath=" + filePath + ", fileSize=" + fileSize + ", makemateId=" + makemateId
